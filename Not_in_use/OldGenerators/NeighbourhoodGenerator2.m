classdef NeighbourhoodGenerator2 < handle
    ...
    methods
        function obj = NeighbourhoodGenerator2(k, L, M)
            obj.k = k;
            obj.L = L;
            obj.M = M;
            obj.cycle = true;
            ...
            %Get first value
            obj.curr = {obj.order, obj.programs(obj.programs_i,:)};
        end
        ...
        function construct_programs(obj)
            ...
            for i = 1:cols
                for j = 1:rows
                    obj.programs(j,i) = mod(j, progs_per_machine(i))+1;
                end
            end
            obj.programs_i = 1;        
